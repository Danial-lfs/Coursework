new Vue({
  ...
  data() {
      return {
          products: [
              ...
              { id: 4, name: 'Biology', price: 500.99, location: "Dubai", spaces: 5, image: 'Biology.jpg' },
              { id: 5, name: 'Science', price: 400.99, location: "Dubai", spaces: 5, image: 'Science.png' },
              { id: 6, name: 'History', price: 249.99, location: "Abu-Dhabi", spaces: 5, image: 'History.jpg' },
              { id: 7, name: 'Geography', price: 249.99, location: "Sharjah", spaces: 5, image: 'Geography.png' },
              { id: 8, name: 'Chemistry', price: 199.99, location: "Sharjah", spaces: 5, image: 'Chemistry.jpg' },
              { id: 9, name: 'Physics', price: 299.99, location: "Ajman", spaces: 5, image: 'Physics.jpg' },
              { id: 10, name: 'Maths', price: 299.99, location: "Ajman", spaces: 5, image: 'Maths.jpg' }
          ],
  ...
  methods: {
      ...
      validateInput() {
          ...
          const phoneRegex = /^\d+$/;
          const isNameValid = nameRegex.test(this.customerName);
          const isPhoneValid = phoneRegex.test(this.customerPhone);
